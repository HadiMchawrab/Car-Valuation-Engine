...
from .carswitch import CarSwitchSpider

class EditSpider(Spider):
    ...
    def parse_ad(self, response):
        if 'dubizzle' in response.url:
           yield from  DubizzleTemplateSpider.parse_ad(self, response)
        if 'opensooq' in response.url:
          yield from OpenSooqTemplateSpider.parse_ad(self,response)
        if 'carswitch' in response.url:
            yield from CarSwitchSpider.parse_ad(self,response)
